...
for jj, thrust in enumerate(thrSweep): 
    ...
    for ii,mLaunch in enumerate(mSeparated):
        ...
        if engMain.strCryo == 'Cryo':
            ...
            CoastToTCM2 = cf.Phase('Coast to TCM2',          TCM1.mEnd,       0, engMain, 'Coast', 0, mdotRCS, mdotOxBoiloff, mdotFuelBoiloff) 
            ...
            CoastToTCM3 = cf.Phase('Coast to TCM3',          TCM2.mEnd,       0, engMain, 'Coast', 0, mdotRCS, mdotOxBoiloff, mdotFuelBoiloff)
