...
def ApogeeRaise(ApogeeChange):
    ...
    delV = (visviva(mu,rF,aF) - visviva(mu,rI,aI)) * 1000
...
class Phase:
    ...
    def __init__(self,strName, mStart, dvPhase, clsEng, strPhaseType, dtPhase, mdotRCS, mdotOxBoiloff, mdotFuelBoiloff):
        ...
        mPropImpulseReserve = 0.02*mPropImpulse # This is 2% of the impulse propellant
...
class Cost:
    def __init__(self, mDryMass, thrEngine, cstRocket):
        ...
        costNRETotal  = costNRELander + costNREEngine + cstRocket # Lander + Enginer + Rocket
